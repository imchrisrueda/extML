        ...
        rows.append(
            {
                ...
                "Train éxito últimos 1000": metrics["train_success_last_window_mean"],
                ...
                "Eval greedy éxito": metrics["final_eval_success_rate_mean"],
            }
        )
...
def main() -> None:
    ...
    print()
    print("Ranking por evaluación greedy final")
